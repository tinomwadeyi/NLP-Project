...
It is based on the `FlashText algorithm <https://arxiv.org/abs/1711.00046>`_. It also worth reading
`Regex was taking 5 days to run. So I built a tool that did it in 15 minutes. <https://medium.freecodecamp.org/regex-was-taking-5-days-flashtext-does-it-in-15-minutes-55f04411025f>`_
...
Thie module is embedded as an external contribution as it is not available on Skywise Foundry

It is cloned from https://github.com/vi3k6i5/flashtext/blob/master/flashtext/keyword.py
commit 5591859aabe3da37499a20d0d0d6dd77e480ed8d

Documentation at http://flashtext.readthedocs.io/en/latest/
"""
